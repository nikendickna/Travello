...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('styles/destinations.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('styles/destinations_responsive.css')?>">
</head>
<body>
				...
				<div class="col">
					<div class="destinations_container item_grid">
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="#">GILI KETAPANG</a></div>
								<div class="destination_subtitle"><p>Paket Wisata Gili KETAPANG</p></div>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="#">GILI LABAK</a></div>
								<div class="destination_subtitle"><p>Paket Wisata Gili Labak dan Pantai 9</p></div>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="#">TOUR MALANG</a></div>
								<div class="destination_subtitle"><p>Paket Wisata City Tour Malang</p></div>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								...
								<div class="destination_subtitle"><p>Paket Wisata Kawah Ijen</p></div>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="#">PANTAI MALANG</a></div>
								<div class="destination_subtitle"><p>Paket Wisata Pantai Malang</p></div>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="#">EXPLORE 3 PULAU</a></div>
								<div class="destination_subtitle"><p>Nusa Penida, Lembongan, Ceningan</p></div>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								...
								<div class="destination_subtitle"><p>Paket Wisata Ranu Kumbolo</p></div>
								<div class="destination_price">From Rp. 450K </div>
								<div class="destination_list">
									<ul>
										<li>Jeep Hardtop</li>
										<li></li>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="#">LOMBOK</a></div>
								<div class="destination_subtitle"><p>Paket Wisata Lombok Tengah/Utara/Timur</p></div>
						...
						<div class="col-xl-4 footer_contact_col">
							<div class="footer_contact_item d-flex flex-column align-items-center justify-content-start text-center">
								...
								<div class="footer_contact_list">
									<ul>
										<li>Office Landline: 083 834 420 002</li>
										<li>Mobile: 081 555 646 793</li>
									</ul>
								</div>
							</div>
						</div>
...
<script src="<?php echo base_url('js/destinations.js')?>"></script>
</body>
</html>